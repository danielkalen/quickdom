...
suite("QuickDom", function() {
  ...
  suite("State", function() {
    ...
    return test("state-based text", function() {
      var divA, divB;
      divA = Dom([
        'div', null, [
          'text', {
